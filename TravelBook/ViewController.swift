...
//  TravelBook
//
//  Created by KERİM İSMAİL TURHAN on 14.06.2022.
//
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    var locaitonManager = CLLocationManager()
                            ...
                            if let subtitle = result.value(forKey: "subtitle") as? String {
                                ...
                                if let latitude = result.value(forKey: "latitude") as? Double {
                                    ...
                                    if let longitude = result.value(forKey: "longitude") as? Double {
                                        ...
                                        commendText.text = annotationSubtitle
                                        
                                        locaitonManager.stopUpdatingLocation()
    ...
    @objc func chooseLocation(gestureRecognizer:UITapGestureRecognizer) {
        ...
        if gestureRecognizer.state == .began {
            ...
            annotation.subtitle = commendText.text
    ...
    @IBAction func saveButtonClicked(_ sender: Any) {
        ...
        newPlace.setValue(commendText.text, forKey: "subtitle")
